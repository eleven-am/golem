...
func (r *mutationResolver) CreateVersionedNote(ctx context.Context, data VersionedNoteCreateInput) (graphql1.PreparedObject, error) {
	return graphql1.ResolvePreparedRoot[graphql1.PreparedObject](ctx)

}

func (r *mutationResolver) UpdateVersionedNote(ctx context.Context, where VersionedNoteWhereUniqueInput, expectedVersion any, data VersionedNoteUpdateInput) (graphql1.PreparedObject, error) {
	return graphql1.ResolvePreparedRoot[graphql1.PreparedObject](ctx)

}

func (r *mutationResolver) UpsertVersionedNote(ctx context.Context, where VersionedNoteWhereUniqueInput, expectation VersionedNoteConcurrencyExpectationInput, create VersionedNoteCreateInput, update VersionedNoteUpdateInput) (graphql1.PreparedObject, error) {
	return graphql1.ResolvePreparedRoot[graphql1.PreparedObject](ctx)

}

func (r *mutationResolver) DeleteVersionedNote(ctx context.Context, where VersionedNoteWhereUniqueInput, expectedVersion any) (graphql1.PreparedObject, error) {
	return graphql1.ResolvePreparedRoot[graphql1.PreparedObject](ctx)
...
func (r *queryResolver) VersionedNote(ctx context.Context, where VersionedNoteWhereUniqueInput) (graphql1.PreparedObject, error) {
	return graphql1.ResolvePreparedRoot[graphql1.PreparedObject](ctx)

}

func (r *queryResolver) VersionedNotes(ctx context.Context, where *VersionedNoteWhereInput, orderBy []*VersionedNoteOrderByInput, cursor *VersionedNoteWhereUniqueInput, distinct []VersionedNoteScalarField, skip *int, take *int) ([]graphql1.PreparedObject, error) {
	return graphql1.ResolvePreparedRoot[[]graphql1.PreparedObject](ctx)
...
func (r *versionedNoteResolver) ID(ctx context.Context, obj graphql1.PreparedObject) (any, error) {
	return graphql1.ResolvePreparedField[any](ctx, obj)

}

func (r *versionedNoteResolver) Body(ctx context.Context, obj graphql1.PreparedObject) (*string, error) {
	return graphql1.ResolvePreparedField[*string](ctx, obj)

}

func (r *versionedNoteResolver) Version(ctx context.Context, obj graphql1.PreparedObject) (any, error) {
	return graphql1.ResolvePreparedField[any](ctx, obj)
...
func (r *Resolver) VersionedNote() VersionedNoteResolver { return &versionedNoteResolver{r} }
...
type versionedNoteResolver struct{ *Resolver }

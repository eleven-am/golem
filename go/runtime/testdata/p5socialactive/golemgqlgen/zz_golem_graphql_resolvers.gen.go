...
func (r *postResolver) Counter(ctx context.Context, obj graphql1.PreparedObject) (*int, error) {
	return graphql1.ResolvePreparedField[*int](ctx, obj)

}

func (r *postResolver) Optional(ctx context.Context, obj graphql1.PreparedObject) (*int, error) {
	return graphql1.ResolvePreparedField[*int](ctx, obj)

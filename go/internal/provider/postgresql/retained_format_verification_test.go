...
func TestPostgreSQLVerifyGatesRetainedCanonicalFormatsInIntrospectionNotComparison(t *testing.T) {
	schema := livePostgreSQLMigrationSchema(t, "public", false, false)

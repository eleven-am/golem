...
func (r *friendshipResolver) CreatedAt(ctx context.Context, obj graphql1.PreparedObject) (any, error) {
	return graphql1.ResolvePreparedField[any](ctx, obj)
...
func (r *postResolver) Search(ctx context.Context, obj graphql1.PreparedObject) (*string, error) {
	return graphql1.ResolvePreparedField[*string](ctx, obj)

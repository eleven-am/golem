...
func TestQueryPlanTypedBuilderMutationsAreIsolatedApplicableAndKilled(t *testing.T) {
	mutations := queryPlanTypedBuilderMutations()
	if len(mutations) != 8 {
		t.Fatalf("typed builder mutations = %#v", mutations)
	}

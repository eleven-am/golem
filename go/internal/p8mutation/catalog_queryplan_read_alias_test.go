...
func TestQueryPlanReadAliasMutationsAreIsolatedApplicableAndKilled(t *testing.T) {
	mutations := queryPlanReadAliasMutations()
	if len(mutations) != 10 {
		t.Fatalf("read alias mutations = %#v", mutations)
	}

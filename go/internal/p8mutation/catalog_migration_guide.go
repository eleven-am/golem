...
func migrationGuideMutations() []Mutation {
	...
	return []Mutation{
		...
		mutation("MIGRATION_GUIDE_FROM_TAG_RELABELED", "relabel the exact released source tag", "go/internal/compatibility/migration_guide.go",
			"MigrationGuidePath                 = \"compatibility/migration-guide-go-v0.0.2-to-v0.1.0.json\"", "MigrationGuidePath                 = \"compatibility/migration-guide-go-v0.0.3-to-v0.1.0.json\"", "./internal/compatibility", "TestGoV002ToV010MigrationGuideIsCanonicalTrustedAndTransitionBound"),
		...
		mutation("MIGRATION_GUIDE_CORPUS_TREE_DRIFT", "replace the exact P7 corpus tree authority", "go/compatibility/migration-guide-go-v0.0.2-to-v0.1.0.json",
			"dce564e9e3aff0b0f96ae8b3278e75d588d2f71c", "ace564e9e3aff0b0f96ae8b3278e75d588d2f71c", "./internal/compatibility", "TestGoV002ToV010MigrationGuideIsCanonicalTrustedAndTransitionBound"),
		mutation("MIGRATION_GUIDE_V1_FUTURE_HISTORY_REJECTED", "hardcode manifest v2 authority to the first released guide path", "go/internal/compatibility/migration_guide.go",
			"return strings.HasPrefix(value.Path, \"compatibility/\") && safeGuidePath(value.Path)", "return value.Path == MigrationGuidePath && strings.HasPrefix(value.Path, \"compatibility/\") && safeGuidePath(value.Path)", "./internal/compatibility", "TestMigrationGuideV1AndManifestV2RemainGenericForFutureTransition"),
	}
}
